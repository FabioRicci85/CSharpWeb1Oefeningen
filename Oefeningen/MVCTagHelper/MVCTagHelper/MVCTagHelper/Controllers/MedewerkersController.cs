...
namespace MVCTagHelper.Controllers
{
    public class MedewerkersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var card = new MedewerkerCard(medewerker);
            return View(card);
        }
        ...
        {
            ViewData["AfdelingId"] = new SelectList(_context.Afdelingen, "AfdelingId", "AfdelingNaam");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("MedewerkerId,AfdelingId,Naam,Voornaam,Email")] Medewerker medewerker)
        {
            ...
            ViewData["AfdelingId"] = new SelectList(_context.Afdelingen, "AfdelingId", "AfdelingNaam", medewerker.AfdelingId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TagHelperDbContext.Medewerkers'  is null.");
            }
            var medewerker = await _context.Medewerkers.FindAsync(id);
            if (medewerker != null)
            {
        ...
        {
          return (_context.Medewerkers?.Any(e => e.MedewerkerId == id)).GetValueOrDefault();
        }
    }
}
